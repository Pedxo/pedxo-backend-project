...
export class OtpService {
  ...
  async sendOtp(payload: SentOtpDto) {
    ...
    if (type === OtpType.EMAIL_VERIFICATION) {
      template = `Kindly verify your action user this link to activate your account https://pedxo-backend.onrender.com/uth/verify-email/?encodedEmail=${encodedEmail}&encodedCode=${encodedCode}`;
