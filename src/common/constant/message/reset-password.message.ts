  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="margin-top: 20px;">
        <a href="https://pedxo.netlify.app/verify-request-reset-pwd/ver-doc/?code=${code}" style="display: inline-block; background-color: #00466a; color: #fff; text-decoration: none; padding: 12px 20px; border-radius: 5px; font-size: 16px;">Reset Password</a>
      </div>
